...
Tutorial:
Execute the **main.py** file *(make sure you have the proper modules installed)*, then click on the "?" icon for further **usage instructions**
...
Tutorial:
Ejecuta el archivo main.py (asegúrate de tener los módulos adecuados instalados), luego haz clic en el icono "?" para obtener más instrucciones de uso.
